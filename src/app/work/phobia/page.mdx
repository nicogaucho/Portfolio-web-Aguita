import logo from '@/images/clients/ocean/logo-black-ocean.webp'
import imageHero from './hero.jpg'
import imageJennyWilson from './jenny-wilson.jpg'

export const caseStudy = {
  client: 'Phobia',
  title: 'Turning ocean complexity into clear, visual intelligence',
  description:
    'We design infographics that synthesize complex ocean dynamics into clear, intuitive visuals. By combining data, maps, and concise narratives, we make key trends, risks, and connections immediately understandable.',
  summary: [
