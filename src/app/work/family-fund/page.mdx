import logo from '@/images/clients/taboire/logo-taboire.webp'
import imageHero from './hero.jpg'
import imageDebraFiscal from './debra-fiscal.jpg'

export const caseStudy = {
  client: 'Taboire',
  title: 'Taboire Business Sustainability Consulting',
  description:
    'Taboire specializes in measuring and reducing carbon emissions. They calculate the carbon footprint of organizations or events, analyze both direct and indirect emissions, and design practical, step-by-step decarbonization strategies.',
  summary: [
