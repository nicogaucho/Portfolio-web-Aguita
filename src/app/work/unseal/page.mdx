import logo from '@/images/clients/pure/pure-surf-logo-black.webp'
import imageHero from './hero.jpg'
import imageEmilySelman from './emily-selman.jpg'

export const caseStudy = {
  client: 'Pureblueretreat',
  title: 'Passionate about the sea',
  description:
    'Pure Blue surf&yoga retreat and Noah Beach lodge are a young association getting along for the same purpose: give and a marvelous and affordable true experiences of surfing',
  summary: [
