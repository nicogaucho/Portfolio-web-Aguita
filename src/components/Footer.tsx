...
const navigation = [
  {
    ...
    links: [
      { title: 'Taboire', href: '/' },
      { title: 'The Ocean Affairs', href: '/' },
      { title: 'Pure surf Maldives', href: '/' },
      {
        title: (
          <>
  ...
  return (
    <Container as="footer" className="mt-24 w-full sm:mt-32 lg:mt-40">
      <FadeIn>
        ...
        <div className="mt-24 mb-20 flex flex-wrap items-end justify-between align-items-center gap-x-6 gap-y-4 border-t border-neutral-950/10 pt-12">
          ...
          <p className="text-sm text-neutral-700">
            © Digital Consulting Agüita SL. {new Date().getFullYear()}
          </p>
          <p className="text-sm text-neutral-700">
            B44711299
          </p>
          <p className="text-sm text-neutral-700">
            ...
            <p className="text-sm text-neutral-700">
            Las Palmas De Grancanaria, 35010, Spain
          </p>
          </div>          
        </div>
      </FadeIn>
